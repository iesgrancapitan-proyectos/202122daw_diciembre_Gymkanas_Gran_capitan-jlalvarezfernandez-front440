...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><button class="btn btn-warning btn-sm"><a href="/organizador/gk-instance/edit-view/{{$gymkana->id}}">Editar</a></button></td>
            <td>
            ...
            <td><a class= "btn btn-success btn-sm text-white" href="/organizador/gk-instance/result/{{$gymkana->id_gymkana}}">Ver</a></td>
